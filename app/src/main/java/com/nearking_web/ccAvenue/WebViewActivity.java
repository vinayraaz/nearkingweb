...
import com.nearking_web.Activity.BuyNow_Activity;
import com.nearking_web.R;
import com.nearking_web.ccAvenue.utility.AvenuesParams;
import com.nearking_web.ccAvenue.utility.Constants;
import com.nearking_web.ccAvenue.utility.LoadingDialog;
import com.nearking_web.ccAvenue.utility.RSAUtility;
...
//get rsa key method
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            if (!ServiceUtility.chkNull(vResponse).equals("")
                ...
                // encVal ="3BA8EB51C0EC05988FEFE404A0250A5A";  //encrypt amount and currency
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(WebViewActivity.this,BuyNow_Activity.class);
